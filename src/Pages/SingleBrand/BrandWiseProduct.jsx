                ...
                <div className="card-body flex-1">
                    ...
                    <div className='flex gap-5 mt-2'>
                        ...
                        <Link to={`/updatebrand/${_id}`}>
                            <button className="tooltip tooltip-right btn bg-black text-white hover:bg-black normal-case" data-tip="Update Product"><BiPencil className='text-xl'></BiPencil></button>
                        </Link>
